...
- Logic
  ...
  - ControlAltAI: Choose Upscale Model
- Image
  - ControlAltAI: Get Image Size Ratio
  - ControlAltAI: Perturbation Texture (New, June 2025)
  - ControlAltAI: Noise Plus Blend
- Flux Region
  - ControlAltAI: Region Mask Generator
  - ControlAltAI: Region Mask Processor
  - ControlAltAI: Region Mask Validator
  - ControlAltAI: Region Mask Conditioning
  - ControlAltAI: Attention Control
  - ControlAltAI: Region Overlay Visualizer
  - ControlAltAI: Attention Cleanup
- HiDream
  - ControlAltAI: HiDream Resolution (New, June 2025)
- Utility
...
### ControlAltAI: HiDream Resolution
ControlAltAI: HiDream Resolution supports hard-coded resolutions, similar to SDXL, and differs significantly from the pixel-based resolution supported by Flux.
